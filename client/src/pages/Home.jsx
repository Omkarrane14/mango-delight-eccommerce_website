...
const LandingPage = () => {
  ...
  useEffect(() => {
    fetch("https://mangoshop.onrender.com/api/products")
      .then((res) => res.json())
      .then((data) => {
        setProducts(data);
      })
    ...
    <div>
      ...
      >
        <div className="container">
          ...
          >
            Your one-stop shop for the finest mangoes and mango products!
          </p>
          <a
            href="#products"
          ...
          >
            Explore Mangoes and Mango Products
          </a>
        </div>
      </section>
            ...
            {[
              {
                ...
                text: "We ensure timely delivery so you receive farm-fresh mangoes and mango products at their peak flavor.",
              },
              {
                icon: "💰",
                title: "Best Prices, Premium Quality",
                text: "Enjoy the finest Alphonso mangoes and mango-based products at competitive prices, straight from trusted farmers.",
              },
              {
                icon: "⭐",
                title: "100% Natural & Chemical-Free",
                text: "Our mangoes are ripened naturally without harmful chemicals, preserving their authentic sweetness and rich aroma.",
              },
            ].map((feature, index) => (
              <div
                key={index}
      ...
      >
        <div className="container">
          ...
          >
           Our carefully curated selection brings you the finest mango products, crafted to deliver the rich, authentic taste of Devgad Alphonso mangoes in every bite.
          </p>
          <Link
            to="/shop"
            className="btn btn-lg mt-4"
